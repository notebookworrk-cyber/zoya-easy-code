...
def _default_metadata() -> dict[str, Any] | None:
    return None
...
class LeaderboardService:
    def __init__(self, base_url: str, api_key: str):
        ...
        self._metadata: dict[str, dict[str, dict[str, Any] | None]] = {}
    ...
    def get_rank(self, leaderboard_id: str, user_id: str) -> LeaderboardEntry | None:
        entries = self._sorted_entries(leaderboard_id)
        for entry in entries:
            if entry.user_id == user_id:
                return entry
    ...
    def update_leaderboard(self, id: str, updates: dict) -> None:
        if id not in self._definitions:
            raise LeaderboardError(f"Leaderboard '{id}' not found", code="NOT_FOUND")
    ...
    def get_reset_schedule(self, id: str) -> str | None:
        if id not in self._definitions:
            raise LeaderboardError(f"Leaderboard '{id}' not found", code="NOT_FOUND")
